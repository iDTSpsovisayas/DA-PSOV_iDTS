...
<head>
  ...
  <style>
    ...
    border-radius: 6px;
    -webkit-box-shadow: 1px 2px 3px rgb(0 0 0 / 25%);
  ...
  .alert {
    color: #4f8a10;
    border-bottom: 2px solid #70b201;
  }
    ...
    <h5 class="text-center" id="txt" name="txt"></h5>
      <form method="POST" action="login.php">
        <div class="mb-3 mt-3">
          ...
          <div class="col-33">
          <div class="alert">
        <strong><i class="fa fa-lock"></i> Login Form</strong>
      </div></div><div class="col-33"></div> </div>
          <div class="row">
            <div class="col-33"></div>
            <div class="col-33">
              <!-- <label for="username"><strong>Component/Unit:</strong></label> -->
              <input type="text" class="form-control" id="username" placeholder="Component/Unit" name="username">
            </div>
            <div class="col-33"></div>
          </div>
          <div class="row">
